...
function dynamicCellWidth() {
  ...
  getGrowthTableWidth(growthTable)
...
function getGrowthTableWidth(growthTable){
  ...
  console.log('v4? total group width ='+totalGroupWidth +' Border pixels = '+borderPixels)
