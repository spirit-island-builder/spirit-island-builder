...
|                                      | Gain a Minor/Major/Other Power Card                  | gain-power-card(x)                                   | z is an icon that appears in the top right of the Power Card                                                                                                     | Dances Up Earthquakes: or(add-presence(2),gain-power-card(major, without Forgetting,no-forget))                                                                                 |
