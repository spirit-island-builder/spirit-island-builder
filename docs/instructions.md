...
| Incarna                              | Add Incarna                                          | incarna(add,x) or incarna(add,x,y)                   | Adds an Incarna. X is the range. Y is an icon (defaults to Ember-Eye's)                                                                                             |                                                                                                        |
|                                      | Move Incarna                                         | incarna(move,x) or incarna(move,x,y)                 | Moves an Incarna. X is the range. Y is an icon (defaults to Ember-Eye's)                                                                                            | Ember-Eyed Behemoth: incarna(move,1)                                                                   |
...
|                                     | custom(_your_text_;{x})                    | Add custom text to the presence node. x is an icon(s) and/or text. Note the semicolon.                                           | Custom energy track: 1,2,custom(Destroy 1 Town or City;{town}/{city}),3,water,4                                                                              |
