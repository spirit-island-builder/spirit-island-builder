...
const growthValues = [
  ...
  },
  {
    ...
    detail: [
      ...
      "gather(x,y) : If y is a condition (terrain, sacred site, beasts, etc), Gather entity x into 1 of your lands with y condition.",
      "gather(x,y) : If y is a number, Gather y of entity x into 1 of your lands.",
      "gather(x,y,z) : Gather z of entity x into lands of condition y. y can be terrain types, sacred site, token types, etc. z can be a numeral or 'each' (or another word at your own risk).",
      "gather(x,y,z) : If z is a word ('each'), Gather x into z lands of condition y.",
      "gather(x,y) : At range x, Gather entity y (dahan, beasts, presence, etc) into a land.",
      "gather(x,y,z) : At range x, Gather entity y into a land with condition z.",
  ...
  },
  {
    ...
    detail: [
      ...
      "push(x,y) : If y is a condition (terrain, sacred site, beasts, etc), Push entity x from 1 of your lands with y condition.",
      "push(x,y) : If y is a number, Push y of entity x from 1 of your lands.",
      "push(x,y,z) : Push z of entity x from lands of condition y. y can be terrain types, sacred site, token types, etc. z can be a numeral or 'each' (or another word at your own risk).",
      "push(x,y,z) : If z is a word ('each'), Push x from z lands of condition y.",
      "push(x,y) : At range x, Push entity y (dahan, beasts, presence, etc) from a land.",
      "push(x,y,z) : At range x, Push entity y from a land with condition z.",
      "push(x,y,z) : At range x, Push numeral z of entity y from a land.",
      "push(x,y,z,w) : At range x, Push numeral w of entity y from a land with condition w.",
    ],
  },
  {
    label: "reclaim",
